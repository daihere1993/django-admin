...
@NgModule({
    declarations: [AppViewerComponent, AppViewerHeaderComponent, AppViewerBodyComponent],
    imports: [CommonModule],
    exports: [AppViewerComponent, AppViewerHeaderComponent, AppViewerBodyComponent]
})
